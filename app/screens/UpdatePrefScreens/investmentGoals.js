...
export default function InvestmentGoalsScreen ({navigation, route}){
    ...
    return (
        <SafeAreaView style={styles.container}>
            ...
            <AppFloatingButton.PrimaryThickOne text={'Finish'} onPress={() => navigation.navigate('Update Preference Confirmation Screen')} />
        </SafeAreaView>
    );
}
