...
// Components
import { StyleSheet, SafeAreaView, Text, View, SectionList, TouchableOpacity, Image } from "react-native";
...
export default function NoAlex({navigation, route}) {
    ...
    const DATA = [
        {
        title: 'Invitations',
        data: [['Dan invites you to join Friendly Bananas', 'Investment: Apple', Images.profilePic.two, () => navigation.navigate('Invitation')], ],
        },
        {
