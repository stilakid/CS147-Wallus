...
export default function David({navigation, route}) {
    ...
    return(
        <SafeAreaView style={styles.container}>
            ...
            <ScrollView> 
                <View style={styles.people}>
                    <View style={styles.person}>
                        ...
                        <TouchableOpacity onPress={() => navigation.navigate('Select Friends', {group: groupID})} style={styles.selectedContainer}>
                    ...
                    <View style={styles.person}>
                        ...
                        <TouchableOpacity onPress={() => navigation.navigate('DavidJenny', {group: groupID})} style={styles.notSelectedContainer}>
            ...
            <AppFloatingButton.PrimaryThickOne text={'Next'} onPress={()=> navigation.navigate("confirmationDavid",{group:groupID})}/>
        </SafeAreaView>
    );
}
